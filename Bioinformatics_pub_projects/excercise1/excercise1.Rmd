---
title: "Excercise 1: Cellular Senescence"
...
Cellular senescence is a cell aging process stimulated in response to cellular stress, whereby normal cells lose the ability to divide through irreversible cell cycle arrest. 
    ...
    * regulation (⬆️or⬇️) of cellular senescence is a process that modulates the frequency, rate or extent of cellular senescence. 
...
```{r plot-CT-sd, echo=TRUE, include=FALSE, results='hide'}
## Plot AVG read count and STDDEV for As and CT samples for selected set of genes
...
```{r plot-avg-count-vs-sd-CT, results='hide'}
...
```{r plot-avg-count-vs-sd-As, include=FALSE, results='hide'}
